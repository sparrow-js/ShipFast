...
const validator = createTypeScriptJsonValidator<ShopDataResponse>(`
...
function processOrder(cart: ShopDataResponse) {
    // Process the items in the cart
    void cart;
}

export default async function requestMarketJson(request: string) {
