      ...
      <div className="relative flex flex-col space-y-4 p-5 sm:p-10">
        ...
        {inputAttrs.name === "image" || inputAttrs.name === "logo" ? (
          ...
          <div className="relative flex w-full max-w-md">
            <input
              {...inputAttrs}
              className="p-2 z-10 flex-1 rounded-md border border-stone-300 text-sm text-stone-900 placeholder-stone-300 focus:border-stone-500 focus:outline-none focus:ring-stone-500 dark:border-stone-600 dark:bg-black dark:text-white dark:placeholder-stone-700"
            />
            {inputAttrs.defaultValue && (
