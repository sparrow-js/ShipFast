...
<div className="max-w-xl mx-auto">
	<div className="p-5">
		...
		<div className="leading-relaxed">
			Your privacy is important to us. It is Ship.Fast policy to respect your
			...
			and consent. We also let you know why we are collecting it and how it will
			be used.
			<br />
			<br />
			You can sign up with your Google account so your Ship.Fast account username
			will be prefilled with your name and your public profile picture.
			<br />
			<br />
			We only retain collected information for as long as necessary to provide
			you with your requested service. What data we store, well protect within
			...
			regard to the personal data processed through Ship.Fast and the services
