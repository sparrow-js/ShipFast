import { Editor, action, makeObservable, obx, computed } from '@/engine/editor-core';
import {
  DockConfig,
  PanelConfig,
  WidgetConfig,
...
import { isPlainObject, uniqueId } from '@/engine/utils';
...
export class Skeleton {
  ...
  @obx.ref private _visibleMaterial = false;
  ...
  @computed get visibleMaterial() {
    return this._visibleMaterial;
  }

  @action
  setVisibleMaterial = (flag: boolean) => {
    this._visibleMaterial = flag
  }
  /**
   * setup events
   *
