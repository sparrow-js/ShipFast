...
import { obx, computed, makeObservable } from '@/engine/editor-core';
import { uniqueId, createContent } from '@/engine/utils';
import { TitleContent } from '@/engine/types';
import WidgetContainer from './widget-container';
import { getEvent } from '@/engine/shell';
