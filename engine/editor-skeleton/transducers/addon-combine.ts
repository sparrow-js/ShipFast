import { TransformedComponentMetadata, FieldConfig, SettingTarget } from '@/engine/types';
import { IconSlot } from '../icons/slot';
import { getConvertedExtraKey } from '@/engine/designer';

export default function addonCombine (metadata: TransformedComponentMetadata): TransformedComponentMetadata {
