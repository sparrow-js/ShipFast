...
import { globalContext, Editor, engineConfig, EngineOptions } from '@/engine/editor-core';
import {
  Designer,
...
import { Hotkey, Project, Skeleton, Setters, Material, Event } from '@/engine/shell';
import { getLogger, isPlainObject } from '@/engine/utils';
