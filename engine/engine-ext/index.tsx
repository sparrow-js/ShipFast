...
import { isJSExpression, isJSFunction, isJSSlot } from '@/engine/types';
...
import ImageSetter from './setter/image-setter';
import IconsSetter from './setter/icons-setter';
