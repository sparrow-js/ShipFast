...
export default class ImageSetter extends React.PureComponent<ImageSetterProps, any> {
  static displayName = 'ImageSetter';

  render() {
    const { onChange, placeholder, value } = this.props;
    return (
      <div>
        <ImageSelector  imageUrl={value} onChange={onChange}>
