...
import { common, SettingField } from '@/engine/engine';
import { SetterType, FieldConfig, CustomView, TitleContent } from '@/engine/types';
import CustomIcon from '../../components/custom-icon';
import { FiEdit3 } from "react-icons/fi";

import './index.scss';

const { editorCabin, skeletonCabin, designerCabin, globalContext } = common;
...
class RowSetter extends Component<RowSetterProps, RowSetterState> {
  ...
  sendToSubView () {
    ...
    const setting = globalContext.get('setting');
    setting.showSubSettingView(<FormSetter key={field.id} field={field} config={config} />)
  }
