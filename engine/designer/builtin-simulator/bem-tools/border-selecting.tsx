...
import { observer, computed, Tip, globalContext, makeObservable } from '@/engine/editor-core';
import { createIcon, isReactComponent } from '@/engine/utils';
import { ActionContentObject, isActionContentObject } from '@/engine/types';
...
class Toolbar extends Component<{ observed: OffsetObserver }> {
  render() {
    ...
    return (
      <div className="lc-borders-actions">
        {actions}
