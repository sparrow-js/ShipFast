import { computed, makeObservable, obx, action, runWithGlobalEventOff, wrapWithEventSwitch } from '@/engine/editor-core';
import { NodeData, isJSExpression, isDOMText, NodeSchema, isNodeSchema, RootSchema, PageSchema, ComponentsMap } from '@/engine/types';
...
import { uniqueId, isPlainObject, compatStage } from '@/engine/utils';
...
export class DocumentModel {
  ...
  getDataMeta(componentName: string): ComponentMeta {
    return this.designer.getDataMeta(componentName);
  }
