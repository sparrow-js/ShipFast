import { obx, computed, makeObservable, runInAction } from '@/engine/editor-core';
import { GlobalEvent, IEditor, isJSExpression } from '@/engine/types';
import { uniqueId } from '@/engine/utils';
import { SettingPropEntry as ShellSettingPropEntry } from '@/engine/shell';
