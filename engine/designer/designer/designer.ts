...
import { obx, computed, autorun, makeObservable, IReactionPublic, IReactionOptions, IReactionDisposer } from '@/engine/editor-core';
import {
  ProjectSchema,
  ComponentMetadata,
  ComponentAction,
...
import { megreAssets, AssetsJson } from '@/engine/utils';
...
export class Designer {
  ...
  @obx.ref private _dataMetasMap = new Map<string, ComponentMeta>();
